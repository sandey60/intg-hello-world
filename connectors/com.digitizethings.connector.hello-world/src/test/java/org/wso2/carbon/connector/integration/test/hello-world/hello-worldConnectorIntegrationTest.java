...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.hello-world;
 ...
 */
public class hello-worldConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "hello-world test case")
